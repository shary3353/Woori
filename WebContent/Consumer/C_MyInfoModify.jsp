        ...
        <div id="wrapper">
            ...
            <div id="myInfo">
                <form action="#" method="POST">
                    <div id="infoBox">
                        <p style="font-size: 25px; font-weight: 600; text-align: left; color: mediumslateblue ">나의 정보 수정</p>
                        <table>
                            <tr>
                                <th>아이디</th>
                                <td>아이디 가져오기</td>
                            ...
                            <tr>
                                <th>비밀번호 확인</th>
                                <td>
                                    <input type="password" name="pwCfm" class="inputs" /><br>
                                    <span id="pwCfmMsg">비밀번호가 일치하지 않습니다.</span>
                                </td>
                            </tr>
                            <tr>
                                <th>생년월일</th>
