        ...
        <div style="min-width: 1920px">
            ...
            <div id="wrapper">
                <div id="naviBox">
                    ...
                    <div id="memReprotList" class="C_MyPageNavi "><a href="# ">신고내역&nbsp;</a></div>
                </div>
                <div id="reportBox">
                    <form action="" method="GET">
                        <span><p style="font-size: 25px; font-weight: 600; text-align: left; color: mediumslateblue; margin-left: 20px; margin-top: 30px;" >신고 내역</p></span>
                        <table>
                            <tr>
                                <th>No</th>
                                <th>신고 분류</th>
