            ...
            <form action="#" method="GET">
                <div>
                    <div class="reservationBox">
                        <h3 style="font-size: 25px; font-weight: 600; color: mediumslateblue">예약내역</h3>
                        <div class="reservationInnerBox">
                            <table>
                                <tr>
                                    <td rowspan="3"><img src="../img/no-image.png" alt="상품사진" class="pImg" /></td>
                                    <td>상품제목</td>
                                </tr>
                                <tr>
                                    <td>가격</td>
            ...
            <form action="#" method="GET">
                <div>
                    <div class="wishListBox">
                        <h3 style="font-size: 25px; font-weight: 600; color: mediumslateblue">위시리스트</h3>
