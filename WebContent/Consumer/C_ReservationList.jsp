	...
	<div style="min-width: 1920px">
		...
		<div id="wrapper">
			<div id="naviBox">
				...
				<div id="memReservationList" class="C_MyPageNavi ">
					<a href="# ">예약내역&nbsp;</a>
				</div>
				<div class="C_MyPageNavi ">
					<a href="# ">신고내역&nbsp;</a>
			...
			<div id="wishListBox">
				<form action="" method="GET">
					<span><p style="font-size: 25px; font-weight: 600; text-align: left; color: mediumslateblue; margin-left: 20px; margin-top: 30px;">예약
							내역</p></span>
					<table>
						<tr>
							<th>No</th>
