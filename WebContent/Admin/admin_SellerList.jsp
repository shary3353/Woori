    ...
    <div id="Wrapper">
        ...
        <div id="Admin_Seller_Content"> <!--판매자관리컨텐츠-->
            ...
            <div id="Admin_Searching">   <!--판매자리스트 검색 부분-->
				<form>
                    <input type="text" name="sSearch" id="searchingSellerInput" placeholder="ID검색란" onkeyup="fnChkByte(this, '50')"><button type="submit" formaction="sSearch" id="searchBtn">검색</button>
                </form>
            </div>  <!--판매자리스트 검색 닫음-->
