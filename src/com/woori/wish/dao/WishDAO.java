...
public class WishDAO {
	...
	public ArrayList<WishDTO> mainWishList(String cid) {
		String sql = "SELECT w.rnum, p.p_name, p.p_price, p.newfilename, w.p_idx" + 
	...
	public void addWishList(String p_idx, String cid) {
		String sql = "INSERT INTO wishlist(wish_idx, cid, p_idx) VALUES(wishlist_seq.nextval,?,?)";
		try {
			ps = conn.prepareStatement(sql);
			ps.setString(1, cid);
